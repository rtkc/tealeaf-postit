...
I was following the M:M Association solution tutorial and everything went smoothly until I tried to shovel a category (e.g. sport) into the post_category of a post (i.e. post.categories << sports) and ran into the following error:
$ post.categories << sports
(0.2ms)  begin transaction
SQL (0.5ms)  INSERT INTO "post_categories" ("category_id", "post_id") VALUES (?, ?)  [["category_id", 3], ["post_id", 1]]
(2.8ms)  rollback transaction
NoMethodError: undefined method `name' for nil:NilClass
I think it’s trying to shovel the Category’s ’name’, but that’s all I can figure out. 
